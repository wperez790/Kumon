...
public class Contexto {
  ...
  /*          iniciar(); */
    ...
    /*private void iniciar() throws Exception{
         this.dataBaseMock = new DataBaseMockLenguaje();
        
    }
    public LenguajeBO construirLenguajeBO(){
        ILenguajeDao lenguajeDao = new LenguajeDaoImpl(dataBaseMock);
        LenguajeBO lenguajeBO = new LenguajeBO(lenguajeDao);
        return lenguajeBO;
